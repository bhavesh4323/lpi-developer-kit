...
Usage:
  ...
  npm run build
  python submissions/shishir-chaudhary/agent.py                      # Interactive mode
  python submissions/shishir-chaudhary/agent.py "Your question here"  # Single question
"""
...
def main():
    ...
    if not mcp.start():
        ...
        sys.exit(1)
    print("  [✓] Connected to LPI MCP server")
